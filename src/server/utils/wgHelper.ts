...
AllowedIPs = ${allowedIps.join(', ')}${extraLines.length ? `\n${extraLines.join('\n')}` : ''}`;
  ...
  generateServerInterface: (
    ...
    const interfaceLines = [
      ...
      wgInterface.contentPaddingAddition !== undefined
        ? [`ContentPaddingAddition = ${wgInterface.contentPaddingAddition}`]
        : []),
      ...(wgInterface.rekeyAfterTime !== null &&
      wgInterface.rekeyAfterTime !== undefined
        ? [`RekeyAfterTime = ${wgInterface.rekeyAfterTime}`]
        : []),
      ...(wgInterface.rekeyTimeout !== null &&
      wgInterface.rekeyTimeout !== undefined
...
PostDown = ${iptablesTemplate(hooks.postDown, wgInterface)}`;
  ...
  generateClientConfig: (
    ...
    const headerProtectionKey =
      userConfig.headerProtectionKey ?? wgInterface.headerProtectionKey;
    const contentPaddingAddition =
      userConfig.contentPaddingAddition ?? wgInterface.contentPaddingAddition;
    ...
    const peerLines = [
      ...
      ...(rekeyAfterTime !== null && rekeyAfterTime !== undefined
        ? [`RekeyAfterTime = ${rekeyAfterTime}`]
        : []),
      ...(rekeyTimeout !== null && rekeyTimeout !== undefined
