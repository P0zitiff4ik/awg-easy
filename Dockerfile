...
RUN apk add linux-headers build-base go git && \
    git clone --depth 1 --branch v3.0.20260805 https://github.com/amnezia-vpn/amneziawg-tools.git && \
    git clone --depth 1 --branch v3.0.20260805 https://github.com/amnezia-vpn/amneziawg-go && \
    cd amneziawg-go && \
    make && \
